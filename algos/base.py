...
class RLAlgorithm(Algorithm):
    ...
    def _train(self, env, policy, initial_exploration_policy,sub_level_policies_paths, pool,g):
        ...
        with self._sess.as_default():
            ...
            for epoch in gt.timed_for(range(self._n_epochs + 1),
                ...
                self._evaluate(epoch,initial_exploration_done,sub_level_policies,g)
    ...
    def _evaluate(self, epoch,initial_exploration_done,sub_level_policies,g):
        ...
        with self._policy.deterministic(self._eval_deterministic):
            paths = rollouts(self._eval_env, self._policy,sub_level_policies,initial_exploration_done,
                             self.sampler._max_path_length, self._eval_n_episodes,g,
                            )
